<div><h5>05.02.14</h5><h1>this is not a title</h1></div><p><a href="https://raw.github.com/adamschwartz/github-markdown-kitchen-sink/master/README.md" target="_blank" class="external">View raw (TEST.md)</a></p>
...
<p>This is <a href="http://example.com" title="Example" target="_blank" class="external">an example</a> link.</p>

<p><a href="http://example.com" target="_blank" class="external">This link</a> has no title attr.</p>

<p>This is <a href="http://example.com" title="Optional Title" target="_blank" class="external">an example</a> reference-style link.</p>
